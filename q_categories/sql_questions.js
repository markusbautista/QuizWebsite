const sql_questions = [
  ...
  {
    question: "A grammatically acceptable and valid combination of indivisible parts such as keywords, identifiers, operators, punctuation marks, or constants of the SQL language (SELECT k FROM COLLEGE).",
  ...
  {
    question: "Refers to any legal combination of keywords and numeric symbols that evaluates to a single data value (SALARY k 12).",
    answer: "Expression",
    category: "SQL"
  },
  {
